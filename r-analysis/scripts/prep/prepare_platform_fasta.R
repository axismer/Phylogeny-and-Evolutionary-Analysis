...
# 将仓库 data/raw/ 下多个单序列 FASTA 合并为 test-data/fixtures/platform_16s.fasta
# 不修改建树逻辑；仅准备真实测试输入。
# =============================================================================
...
out_fasta <- file.path(r_root, "test-data", "fixtures", "platform_16s.fasta")
